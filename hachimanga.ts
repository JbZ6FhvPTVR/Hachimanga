...
const SOURCE_DOMAIN = "https://hachiraw.net/"

export class hachimanga extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'hachimanga' }
    get description(): string { return 'hachimanga raw' }
    get author(): string { return 'me' }
